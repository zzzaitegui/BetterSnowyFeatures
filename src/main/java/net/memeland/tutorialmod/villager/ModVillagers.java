package net.memeland.tutorialmod.villager;
...
public class ModVillagers {
    ...
    public static final RegistryObject<VillagerProfession> JEW = VILLAGER_PROFESSIONS.register("jew",
            () -> new VillagerProfession("jew", x -> x.get() == JUMPY_BLOCK_POI.get(),
                    x -> x.get() == JUMPY_BLOCK_POI.get(), ImmutableSet.of(), ImmutableSet.of(), SoundEvents.VILLAGER_WORK_ARMORER));

    public static final void registerPOIs() {
        try {
