package net.memeland.tutorialmod.networking;

import net.memeland.tutorialmod.TutorialMod;
import net.memeland.tutorialmod.networking.packet.*;
...
public class ModMessages {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(ResourceLocation.fromNamespaceAndPath(TutorialMod.MOD_ID, "messages"))
                .networkProtocolVersion(() -> "1.0") // Whether or not packets are still compatible with each other
        ...
        net.messageBuilder(ExampleC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        net.messageBuilder(DrinkC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
