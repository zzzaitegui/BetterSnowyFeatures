...
public class SnowOverlayModelRegistry {
    ...
    static {
        SNOWY_TEXTURE_MODELS.put("stone", new ResourceLocation(BetterSnowyFeaturesMod.MOD_ID, "block/snowy_stone"));
        SNOWY_TEXTURE_MODELS.put("gravel", new ResourceLocation(BetterSnowyFeaturesMod.MOD_ID, "block/snowy_gravel"));
        SNOWY_TEXTURE_MODELS.put("spruce_planks", new ResourceLocation(BetterSnowyFeaturesMod.MOD_ID, "block/snowy_spruce_planks"));
        SNOWY_TEXTURE_MODELS.put("blue_ice", new ResourceLocation(BetterSnowyFeaturesMod.MOD_ID, "block/snowy_blue_ice"));
        SNOWY_TEXTURE_MODELS.put("sand", new ResourceLocation(BetterSnowyFeaturesMod.MOD_ID, "block/snowy_sand"));
        SNOWY_TEXTURE_MODELS.put("pumpkin", new ResourceLocation(BetterSnowyFeaturesMod.MOD_ID, "block/snowy_pumpkin"));
    }
