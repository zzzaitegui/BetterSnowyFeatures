package net.memeland.templatemod.networking;

import net.memeland.templatemod.TemplateMod;
import net.memeland.templatemod.networking.packet.*;
...
public class ModMessages {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(ResourceLocation.fromNamespaceAndPath(TemplateMod.MOD_ID, "messages"))
